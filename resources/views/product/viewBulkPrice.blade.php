...
@section('title', 'Bulk Price')
@section('prob', 'Bulk Price')
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        ...
        <p class="category"> Here you update your Price</p>
      </div>
      <div class="card-body">
        <form id="searchForm">
        @csrf
    ...
    e.preventDefault();
      $.ajax({
        ...
        error: function (error) {
          //console.log(error);
          //alert('Data Not Updated');
          nowuiDashboard.showNotification('top','center','danger','Data Not Updated');
        }
      });
    });
  });
