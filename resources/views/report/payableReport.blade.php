  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <p class="category"> Payable Report</p>
      </div>
      <div class="card-body table-responsive">
        ...
        <div class="row">
            <div class="col-md-4">
                <button class="btn btn-primary" name="btn" onclick="payable()">Generate Report</button>
            </div>
        </div><br><br>
        ...
        <tr>
          ...
          <td style="text-align: center;">Payable Report</td>
