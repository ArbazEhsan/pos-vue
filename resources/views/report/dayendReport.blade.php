  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <p class="category"> Day End Report</p>
      </div>
      <div class="card-body table-responsive">
        ...
        <div class="row">
            <div class="col-md-4">
                <button class="btn btn-primary" name="btn" onclick="dayend()">Generate Report</button>
            </div>
        </div><br><br>
        ...
        <!-- <div class="row" >
          <div class="col-md-6">
            <ul>
                <li><strong>Day End Report</strong></li>
        ...
        <tr>
          ...
          <td style="text-align: center;">Dayend Report</td>
