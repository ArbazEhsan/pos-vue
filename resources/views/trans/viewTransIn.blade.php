...
@section('prob', 'Transaction / Cash In')
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title"> View Cash In</h4>
        <p class="category"> Here you view your all Cash In Transaction</p>
      </div>
      <div class="card-body">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$data->amount}}</td>
                <td>
                  <a class="btn btn-danger" href="/deleteTransIn/{{$data->id}}">Delete</a>
                </td>
              </tr>
              @endforeach
            </tbody> 
