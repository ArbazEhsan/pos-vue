...
@section('title', 'Home')
@section('prob', 'Check Point / Vendor')
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        ...
        <p class="category"> Here you view your all Vendor</p>
      </div>
      <div class="card-body">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="/statusVen/{{$data->status}}/{{$data->id}}">{{$txt2}}</a>
